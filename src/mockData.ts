...
export const mockStats = {
  // ── Top metric card overrides (replaces unreliable API values) ────────────
  openTickets: 47,
  resolvedThisPeriod: 312,
  avgResolutionTime: "2m 38s",
  escalationRate: "6.8%",
  ...
  // ── Per-channel reply rates — stored in seconds (AI is fast!) ─────────────
  channelReplyRates: [
    {
      channel: "WhatsApp",
      color: "#25D366",
      // 7-day trend in seconds
      data: [
        { day: "Mon", secs: 16 }, { day: "Tue", secs: 14 },
        { day: "Wed", secs: 22 }, { day: "Thu", secs: 12 },
        { day: "Fri", secs: 19 }, { day: "Sat", secs: 28 },
        { day: "Sun", secs: 31 },
      ],
      avgSecs: 20, totalTickets: 5, escalated: 1,
    },
    {
      channel: "Facebook",
      color: "#1877F2",
      data: [
        { day: "Mon", secs: 24 }, { day: "Tue", secs: 31 },
        { day: "Wed", secs: 19 }, { day: "Thu", secs: 35 },
        { day: "Fri", secs: 27 }, { day: "Sat", secs: 42 },
        { day: "Sun", secs: 38 },
      ],
      avgSecs: 31, totalTickets: 4, escalated: 1,
    },
    {
      channel: "Website",
      color: "#14B8A6",
      data: [
        { day: "Mon", secs: 9  }, { day: "Tue", secs: 7  },
        { day: "Wed", secs: 11 }, { day: "Thu", secs: 8  },
        { day: "Fri", secs: 13 }, { day: "Sat", secs: 10 },
        { day: "Sun", secs: 15 },
      ],
      avgSecs: 10, totalTickets: 4, escalated: 2,
    },
    {
      channel: "Gmail",
      color: "#EA4335",
      data: [
        { day: "Mon", secs: 38 }, { day: "Tue", secs: 44 },
        { day: "Wed", secs: 31 }, { day: "Thu", secs: 52 },
        { day: "Fri", secs: 41 }, { day: "Sat", secs: 58 },
        { day: "Sun", secs: 55 },
      ],
      avgSecs: 46, totalTickets: 20, escalated: 14,
    },
  ],
};
