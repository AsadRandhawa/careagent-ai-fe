        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-4 relative z-10">
              <div className="h-px bg-border-faint flex-1" />
            ...
            <button 
              ...
              type="button"
              className="mt-6 w-full flex items-center justify-center gap-3 bg-surface border border-border-mid hover:bg-surface-high hover:border-border-strong text-text-primary py-3.5 rounded-xl text-sm font-bold transition-all relative z-10"
            >
