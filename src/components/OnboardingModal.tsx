...
import { X, Building2, MessageSquareText, FileText, Mail, ArrowRight, ArrowLeft, Bot, CheckCircle2, Loader2, CreditCard, Zap, Sparkles } from "lucide-react";
...
export const OnboardingModal = () => {
  ...
  const handleStripeCheckout = async () => {
    try {
      ...
      toast("Failed to connect to payment. Try again.", "error");
    }
  };
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-4xl bg-bg border border-border-faint rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-[620px]"
      >
        {/* Left Sidebar */}
            ...
            >
                ...
                <div className="flex-1 flex flex-col justify-center items-center text-center">
                  ...
                  <div className="grid grid-cols-2 gap-4 w-full max-w-lg">
                    <button onClick={() => setCurrentStep(1)} className="p-6 rounded-2xl border-2 border-border-faint hover:border-brand/40 bg-surface text-left transition-all group hover:shadow-lg">
                      ...
                      <div className="text-2xl font-black text-brand mb-3">$0<span className="text-[12px] text-text-muted font-semibold">/mo</span></div>
                    ...
                    <button onClick={handleStripeCheckout} className="p-6 rounded-2xl border-2 border-brand bg-brand/5 text-left transition-all relative shadow-glow hover:shadow-xl">
                      ...
                      <div className="text-2xl font-black text-brand mb-3">$20<span className="text-[12px] text-text-muted font-semibold">/mo</span></div>
                      <div className="space-y-1.5">
              ...
              {currentStep === 1 && (
                <div className="flex-1 flex flex-col justify-center">
                  ...
                  <p className="text-sm text-text-muted mb-8 max-w-md">What's your company called, what do you sell, and who are your customers?</p>
                  <textarea
                    autoFocus
                    ...
                    placeholder="e.g. We are 'Acme Coffee'. We sell high-end, ethically sourced coffee beans..."
                  />
                </div>
              )}
              ...
              {currentStep === 2 && (
                <div className="flex-1 flex flex-col justify-center">
                  ...
                  <p className="text-sm text-text-muted mb-8 max-w-md">Watch the live preview adapt as you type.</p>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <textarea
                      ...
                      placeholder="e.g. Extremely polite, highly professional, no emojis..."
                    />
                    <div className="bg-bg-elevated border border-border-faint rounded-2xl p-5 flex flex-col">
                      ...
                      <div className="flex-1 flex items-center justify-center">
                        <div className="bg-brand/10 border border-brand/20 text-text-primary p-4 rounded-xl rounded-bl-sm text-[13px] leading-relaxed">
                          {previewText}
                        </div>
                      </div>
                    </div>
              ...
              {currentStep === 3 && (
                <div className="flex-1 flex flex-col justify-center items-center text-center">
                  ...
                  <p className="text-sm text-text-muted mb-6 max-w-md mx-auto">Upload one file — a policy doc, FAQ list, or product manual.</p>
                  <div
              ...
              {currentStep === 4 && (
                <div className="flex-1 flex flex-col justify-center items-center text-center">
                  ...
                  <p className="text-sm text-text-muted mb-8 max-w-md mx-auto">Connect your support email to start automating replies instantly.</p>
